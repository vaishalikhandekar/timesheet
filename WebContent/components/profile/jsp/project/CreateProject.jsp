...
<body>
			...
			action="/CreateProjectSubmit" method="POST" role="form"
			theme="bootstrap">
			...
			<div class="form-group">
				<label>Description:</label> <input type="text" class="form-control"
					name="projectDetail.description" />
			</div>
			<br>

			<div class="form-group">
				<label>Start Date:</label> <input type="text" id="datepicker"
					class="dateTxt" name="projectDetail.startDate" placeholder="mm/dd/yy"/>
			</div>
			<br>

			<div class="form-group">
				<label>End Date:</label> <input type="text" id="datepicker"
					class="dateTxt" name="projectDetail.endDate" placeholder="mm/dd/yy"/>
			</div>
