                        ...
                        <s:iterator value="employeeDetailList" status="stat">
                                ...
                                <tr>
                                    ...
                                    <td><s:url var="updateEmployeeURL" action="ReadEmployee" escapeAmp="false">
                                        ...
                                        </s:url> <s:a href="%{updateEmployeeURL}">Update</s:a> <!-- <s:url id="EmployeeDeleteURL" action="DeleteEmployee" escapeAmp="false">
                                                                        <s:param name="employeeDetail.employeeID" value="%{employeeID}" />
                                                                        </s:url>
                                                                    <s:a href="%{EmployeeDeleteURL}">Delete</s:a>
                                                                         -->
                                       <a href="#DeleteEmployee" data-toggle="modal">Delete</a>
                                       </td>
                                </tr>
                        </s:iterator>
