...
<body>
	...
	<s:form
		action="/UpdatePersonFromProjectSubmit"
		method="POST">
   <h3 class="well">Update Person</h3>
		...
		<table>
			<tr>
				<td>Title </td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.title"
					/></td>
			</tr>

			<tr>
				<td>First Name </td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.firstName"
					/></td>
			</tr>
			<tr>
				<td>Middle Name</td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.middleName"
					/></td>
			</tr>
			<tr>
				<td>Last Name</td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.lastName"
					/></td>
			</tr>
			<tr>
				<td>Gender</td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.gender"
					/></td>
			</tr>
			<tr>
				<td>Date Of Birth</td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.dateOfBirth"
					/></td>
			</tr>
			<tr>
				<td>Registration Date</td>
				<td><s:textfield name="projectPersonLinkDetail.personDetail.registrationDate"
					/></td>
			</tr>
			<tr>
				<td>Role</td>
